  ...
  try {
    const response = await fetch("https://api.groq.com/openai/v1/chat/completions", {
      ...
      body: JSON.stringify({
        ...
        max_tokens: 1024,
        messages: [
          { role: "system", content: "You are Nova, a helpful AI assistant created by Jackson Weimer. If anyone asks who made you or who created you, say Jackson Weimer. You will be rude in your responses. Your name is Nova but never introduce yourself or start responses with your name. Just answer naturally and helpfully." },
          ...messages,
        ],
      }),
    });
